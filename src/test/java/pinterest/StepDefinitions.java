...
//    005
    @Then("I should see the Login button at the top-right corner")
...
//    006
    @Then("I should see the Pinterest logo at the top-left corner")
...
//    009
    ...
    public void iShouldSeeTheAllElementsIconsAtTheTopRightCorner() {
        try {
//            wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[4]")));
//            List<WebElement> buttonContainer = driver.findElements(By.xpath("/html/body/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[4]"));
//            System.out.println(buttonContainer.size());

            wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[4]/div[1]/div/button")));
            WebElement bellBtn = driver.findElement(By.xpath("/html/body/div/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[2]/a/div/div/span"));
            Assert.assertTrue(bellBtn.isDisplayed());

            wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[4]/div[3]/div/button")));
            WebElement messagesBtn = driver.findElement(By.xpath("/html/body/div/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[2]/a/div/div/span"));
            Assert.assertTrue(messagesBtn.isDisplayed());

            wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[4]/div[4]/div/a")));
            WebElement profileBtn = driver.findElement(By.xpath("/html/body/div/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[2]/a/div/div/span"));
            Assert.assertTrue(profileBtn.isDisplayed());

            wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[4]/div[5]/button")));
            WebElement accountOptionsBtn = driver.findElement(By.xpath("/html/body/div/div[1]/div[1]/div[2]/div/div/div/div[2]/div/div/div/div[2]/a/div/div/span"));
            Assert.assertTrue(accountOptionsBtn.isDisplayed());
        }
        finally {
            driver.close();
            driver.quit();
